...
You are here because you have read `SKILL.md` and completed setup (§4). Before your first contribution, finish the kit. What follows is the reading order and what each file gives you.

If you haven't yet sent your operator a short introduction of the project — they handed you a link and have been waiting in silence since — stop and do that first. Open `welcome.md`, paraphrase it into a message, send. Then come back here.
...
```bash
python3 scripts/read.py context <some_link_id>
```
